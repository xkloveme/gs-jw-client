    ...
    <div ref="pdfDom">
      ...
      <div style="text-align: center; margin: 200px auto; width: 500px">
        ...
        >
          ...
          <span style="font-family: DengXian; text-decoration: underline; margin: 10px">{{
            $formatDay(new Date(), "YYYY")
          }}</span>
      ...
      <p
        ...
        "
      >
        <span style="font-family: DengXian">拱墅区监察委员会</span>
      </p>
      <p
        style="
          text-align: center;
      ...
      >
        <tr style="height: 36.4pt">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">手机号</span>
            </p>
          </td>
          <td
            style="
        ...
        <tr style="height: 41.15pt">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.employer }}</span>
            </p>
          </td>
          <td
            colspan="2"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">现任职位</span>
            </p>
          </td>
          <td
            style="
        ...
        <tr style="height: 41.15pt">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">分管工作</span>
            </p>
          </td>
          <td
            colspan="3"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">婚姻状况</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{
                form.marriage | filterSelect($utils.marriage)
              }}</span>
            </p>
          </td>
        </tr>
        ...
        <tr style="height: 41.15pt">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">工资收入(万元)</span>
            </p>
          </td>
          <td
            colspan="3"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.income }}</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">其他收入(万元)</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.otherIncome }}</span>
            </p>
          </td>
          <td
            colspan="2"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">家庭年收入(万元)</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.homeYearIncome }}</span>
            </p>
          </td>
        </tr>
        ...
        <tr style="height: 43.8pt">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">个人爱好</span>
            </p>
          </td>
          <td
            colspan="3"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.like }}</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">家庭地址</span>
            </p>
          </td>
          <td
            colspan="4"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.homeAddress }}</span>
            </p>
          </td>
        </tr>
        ...
        <tr style="height: 43.8pt">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">街道</span>
            </p>
          </td>
          <td
            colspan="3"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.jd }}</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">部门社区</span>
            </p>
          </td>
          <td
            colspan="4"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.bm }}</span>
            </p>
          </td>
        </tr>

        <tr style="height: 41.15pt" v-if="form.marriage == '02'">
          <td
            style="
              width: 36.1pt;
              border-style: solid;
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">配偶姓名</span>
            </p>
          </td>
          <td
            colspan="3"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.spouseName }}</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">配偶身份证号</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.spouseIdCard }}</span>
            </p>
          </td>
          <td
            colspan="2"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">配偶手机号</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.spousePhone }}</span>
            </p>
          </td>
        </tr>
        ...
        <tr style="height: 41.15pt" v-if="form.marriage == '02'">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">配偶工作单位</span>
            </p>
          </td>
          <td
            colspan="3"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.spousedEmployer }}</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">配偶现任职位</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.spousedDuty }}</span>
            </p>
          </td>
          <td
            colspan="2"
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">配偶年收入(万元)</span>
            </p>
          </td>
          <td
            style="
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">{{ form.spouseYearIncome }}</span>
            </p>
          </td>
        </tr>
        ...
        <tr style="height: 106.65pt">
          ...
          >
            <p style="text-align: center; line-height: 115%; widows: 0; orphans: 0">
              <span style="font-family: DengXian">其他补充</span>
            </p>
          </td>
          <td
            colspan="8"
  ...
  methods: {
    ...
    ExportSavePdf() {
      ...
      html2canvas(element, {
        ...
        while (renderedHeight < canvas.height) {
          console.log("🐛:: ExportSavePdf -> canvas.height", canvas.height, imgHeight);
